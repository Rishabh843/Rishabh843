...
[![My Skills](https://skillicons.dev/icons?i=py,mysql,aws,git,html,css,js,kafka,linux,ubuntu,sublime,vscode,docker,figma,firebase,&theme=dark&perline=10)](https://skillicons.dev)
